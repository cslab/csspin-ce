...
The csspin-ce repository is hosted on a private GitLab instance, while the
repository itself is mirrored to [GitHub](https://github.com/cslab/csspin-ce)
...
Please follow the guidelines below when contributing to the csspin-ce project.
...
repository](https://github.com/cslab/csspin-ce/issues) for reporting issues
...
3. `git clone <your-fork-or-repo-url> csspin-ce && cd csspin-ce && pre-commit install`
...
> This section is only relevant for maintainers of the csspin-ce project.

The version scheme used is major.minor.patch following semver.org.

Releases are created by csspin-ce maintainers within the GitLab instance hosting
this repository.
...
1. Create the release notes by opening a new merge request at the csspin-ce
